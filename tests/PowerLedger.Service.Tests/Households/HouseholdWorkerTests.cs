...
public sealed class HouseholdWorkerTests : IAsyncLifetime
{
    ...
    private static async Task Pair(WorkerPc adder, WorkerPc joiner)
    {
    ...
    private sealed class WorkerPc : IAsyncDisposable
    {

...
/// five minutes after, while the user allows it, it asks the service which monitors it knows, reads them off the UI thread,
/// and reports each one the service listed, under the service's own name for it, with whatever it answered: a brightness,
/// a power state, or both. It asks the monitors nothing when the service lists none, or when the service's latest reading
